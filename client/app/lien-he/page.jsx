          ...
          <main className="flex-1 pt-3 pb-10">
            <div className="w-full min-h-screen">
                ...
                <div className="overflow-hidden bg-white border border-gray-200 shadow-lg rounded-xl">
                    ...
                    {/* Left: Contact Form */}
                    <div className="flex items-center justify-center flex-1 p-4 border-b border-gray-200 sm:p-8 md:border-b-0 md:border-r">
                        <form
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 bg-white border border-gray-300 rounded focus:outline-none focus:border-orange-500"
                            required
                        />
                        <input
                            name="Phone"
                    ...
                    {/* Right: Company Info */}
                    <div className="flex items-center justify-center flex-1 p-4 bg-white sm:p-8 md:rounded-r-xl">
